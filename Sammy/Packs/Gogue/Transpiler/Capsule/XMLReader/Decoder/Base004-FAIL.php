      ...
      if (preg_match ($this->commandBlockRe, $line_, $match)) {
        ...
        for ($i = $index + 1; $i < $capsuleBodyLinesCount; $i++) {
          ...
          if ($this->commandBlockSignature ($line)) {
            ...
            #echo "Start Command => ", trim ($capsuleBodyLines [$commandBlock[2]]), "\n\n End Command => ", trim ($capsuleBodyLines [$commandBlock[1] - 1]), "\n\n\n\n\n";
            ...
            #echo ">>: ", $capsuleBodyLines [$startPosition], "\n";
            ...
            for ($currentLineIndex = $startPosition + 1; $currentLineIndex <= ($i + 1); $currentLineIndex++) {
              ...
              #echo ">>: ", $capsuleBodyLines [$currentLineIndex], "\n";

              $capsuleBodyLines [$currentLineIndex] = "# code";
            }

            #print_r ($capsuleBodyLines);
